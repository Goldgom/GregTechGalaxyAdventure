declare module "packages/xueluoanping/dtbloomingnature/systems/leaves/$DynamicSnowyFirLeavesBlock" {
...
export class $DynamicSnowyFirLeavesBlock extends $DynamicLeavesBlock {
 ...
 */
export type $DynamicSnowyFirLeavesBlock$Type = ($DynamicSnowyFirLeavesBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $DynamicSnowyFirLeavesBlock_ = $DynamicSnowyFirLeavesBlock$Type;
}}
