declare module "packages/codyhuh/ambientadditions/common/items/$DartItem" {
import {$Item, $Item$Type} from "packages/net/minecraft/world/item/$Item"
import {$UUID, $UUID$Type} from "packages/java/util/$UUID"
import {$Player, $Player$Type} from "packages/net/minecraft/world/entity/player/$Player"
import {$DartEntity, $DartEntity$Type} from "packages/codyhuh/ambientadditions/common/entities/item/$DartEntity"
...
public "createArrow"(arg0: $Level$Type, arg1: $ItemStack$Type, arg2: $LivingEntity$Type): $DartEntity
}
/**
...
declare module "packages/codyhuh/ambientadditions/common/items/$BlowgunItem" {
import {$UUID, $UUID$Type} from "packages/java/util/$UUID"
...
export class $BlowgunItem extends $ProjectileWeaponItem {
static readonly "DART_ONLY": $Predicate<($ItemStack)>
...
public "customArrow"(arg0: $DartEntity$Type): $DartEntity
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BlowgunItem$Type = ($BlowgunItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $BlowgunItem_ = $BlowgunItem$Type;
}}
declare module "packages/codyhuh/ambientadditions/common/entities/item/$DartEntity" {
...
export class $DartEntity extends $AbstractArrow implements $IEntityAdditionalSpawnData {
 "inGround": boolean
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DartEntity$Type = ($DartEntity);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $DartEntity_ = $DartEntity$Type;
}}
declare module "packages/codyhuh/ambientadditions/common/items/$StarfishArmItem" {
import {$Item, $Item$Type} from "packages/net/minecraft/world/item/$Item"
...
export class $StarfishArmItem extends $Item {
static readonly "BY_BLOCK": $Map<($Block), ($Item)>
static readonly "BASE_ATTACK_DAMAGE_UUID": $UUID
static readonly "BASE_ATTACK_SPEED_UUID": $UUID
static readonly "MAX_STACK_SIZE": integer
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $StarfishArmItem$Type = ($StarfishArmItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $StarfishArmItem_ = $StarfishArmItem$Type;
}}
declare module "packages/codyhuh/ambientadditions/common/items/$CrateItem" {
...
static readonly "DATA_CREATURE": string
static readonly "BY_BLOCK": $Map<($Block), ($Item)>
static readonly "BASE_ATTACK_DAMAGE_UUID": $UUID
static readonly "BASE_ATTACK_SPEED_UUID": $UUID
static readonly "MAX_STACK_SIZE": integer
...
public static "containsEntity"(arg0: $ItemStack$Type): boolean
public "successfulCrate"(arg0: $LivingEntity$Type, arg1: $Player$Type, arg2: $InteractionHand$Type, arg3: $ItemStack$Type, arg4: $Level$Type): $InteractionResult
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 ...
 */
declare global {
export type $CrateItem_ = $CrateItem$Type;
}}
declare module "packages/codyhuh/ambientadditions/common/items/$YetiFeedersItem" {
import {$Component, $Component$Type} from "packages/net/minecraft/network/chat/$Component"
import {$ItemStack, $ItemStack$Type} from "packages/net/minecraft/world/item/$ItemStack"
...
export class $YetiFeedersItem extends $ArmorItem implements $GeoItem {
static readonly "MATERIAL": $ArmorMaterial
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $YetiFeedersItem$Type = ($YetiFeedersItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $YetiFeedersItem_ = $YetiFeedersItem$Type;
}}
declare module "packages/codyhuh/ambientadditions/common/items/$DuckyMaskItem" {
import {$Component, $Component$Type} from "packages/net/minecraft/network/chat/$Component"
import {$ItemStack, $ItemStack$Type} from "packages/net/minecraft/world/item/$ItemStack"
import {$Equipable, $Equipable$Type} from "packages/net/minecraft/world/item/$Equipable"
import {$Block, $Block$Type} from "packages/net/minecraft/world/level/block/$Block"
...
export class $DuckyMaskItem extends $ArmorItem implements $GeoItem {
static readonly "MATERIAL": $ArmorMaterial
static readonly "DISPENSE_ITEM_BEHAVIOR": $DispenseItemBehavior
readonly "type": $ArmorItem$Type
readonly "knockbackResistance": float
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DuckyMaskItem$Type = ($DuckyMaskItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $DuckyMaskItem_ = $DuckyMaskItem$Type;
}}
declare module "packages/codyhuh/ambientadditions/common/items/$AACatchableItem" {
import {$Fluid, $Fluid$Type} from "packages/net/minecraft/world/level/material/$Fluid"
import {$Component, $Component$Type} from "packages/net/minecraft/network/chat/$Component"
import {$UUID, $UUID$Type} from "packages/java/util/$UUID"
import {$Item$Properties, $Item$Properties$Type} from "packages/net/minecraft/world/item/$Item$Properties"
...
export class $AACatchableItem extends $BucketItem {
static readonly "BY_BLOCK": $Map<($Block), ($Item)>
static readonly "BASE_ATTACK_DAMAGE_UUID": $UUID
static readonly "BASE_ATTACK_SPEED_UUID": $UUID
static readonly "MAX_STACK_SIZE": integer
...
constructor(arg0: $Supplier$Type<($EntityType$Type<(any)>)>, arg1: $Item$Type, arg2: boolean, arg3: $Item$Properties$Type)
constructor(arg0: $Supplier$Type<($EntityType$Type<(any)>)>, arg1: $Fluid$Type, arg2: $Item$Type, arg3: boolean, arg4: $Item$Properties$Type)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $AACatchableItem$Type = ($AACatchableItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $AACatchableItem_ = $AACatchableItem$Type;
}}
declare module "packages/codyhuh/ambientadditions/common/blocks/$AAFrogspawnBlock" {
...
export class $AAFrogspawnBlock extends $FrogspawnBlock {
...
public "spawnTadpoles"(arg0: $ServerLevel$Type, arg1: $BlockPos$Type, arg2: $RandomSource$Type): void
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $AAFrogspawnBlock$Type = ($AAFrogspawnBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $AAFrogspawnBlock_ = $AAFrogspawnBlock$Type;
}}
