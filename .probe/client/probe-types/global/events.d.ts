...
import {$RegisterIngredientsEventJS, $RegisterIngredientsEventJS$Type} from "packages/pie/ilikepiefoo/compat/jei/events/$RegisterIngredientsEventJS"
...
import {$RegisterVanillaCategoryExtensionsEventJS, $RegisterVanillaCategoryExtensionsEventJS$Type} from "packages/pie/ilikepiefoo/compat/jei/events/$RegisterVanillaCategoryExtensionsEventJS"
import {$RegisterRecipesEventJS, $RegisterRecipesEventJS$Type} from "packages/pie/ilikepiefoo/compat/jei/events/$RegisterRecipesEventJS"
...
import {$RegisterGUIHandlersEventJS, $RegisterGUIHandlersEventJS$Type} from "packages/pie/ilikepiefoo/compat/jei/events/$RegisterGUIHandlersEventJS"
...
import {$ClickedInfoBadgeEventJS, $ClickedInfoBadgeEventJS$Type} from "packages/snownee/lychee/compat/kubejs/$ClickedInfoBadgeEventJS"
...
import {$RegisterRecipeTransferHandlersEventJS, $RegisterRecipeTransferHandlersEventJS$Type} from "packages/pie/ilikepiefoo/compat/jei/events/$RegisterRecipeTransferHandlersEventJS"
...
import {$RegisterAdvancedEventJS, $RegisterAdvancedEventJS$Type} from "packages/pie/ilikepiefoo/compat/jei/events/$RegisterAdvancedEventJS"
...
export namespace JEIAddedEvents {
