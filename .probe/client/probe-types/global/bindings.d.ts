...
import {$PropertyKeys, $PropertyKeys$Type} from "packages/com/gbth/gbthcore/gtceu/material/$PropertyKeys"
...
import {$GreateValues, $GreateValues$Type} from "packages/electrolyte/greate/$GreateValues"
import {$MaterialFlags, $MaterialFlags$Type} from "packages/com/gbth/gbthcore/gtceu/material/$MaterialFlags"
...
import {$MaterialFlags as $MaterialFlags$0, $MaterialFlags$Type as $MaterialFlags$0$Type} from "packages/com/gregtechceu/gtceu/api/data/chemical/material/info/$MaterialFlags"
...
import {$TieredOutputItem, $TieredOutputItem$Type} from "packages/electrolyte/greate/compat/kubejs/item/$TieredOutputItem"
...
const GBTHCorePropertyKeys: typeof $PropertyKeys
...
const TieredOutputItem: typeof $TieredOutputItem
...
const GBTHCoreMaterialFlags: typeof $MaterialFlags
...
const GTMaterialFlags: typeof $MaterialFlags$0
