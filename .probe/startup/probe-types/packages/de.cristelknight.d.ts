declare module "packages/de/cristelknight/doapi/common/block/$ChairBlock" {
...
declare module "packages/de/cristelknight/doapi/common/block/$WindowBlock" {
import {$IntegerProperty, $IntegerProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$IntegerProperty"
import {$LevelAccessor, $LevelAccessor$Type} from "packages/net/minecraft/world/level/$LevelAccessor"
...
declare module "packages/de/cristelknight/doapi/forge/terraform/sign/block/$TerraformWallSignBlock" {
import {$BooleanProperty, $BooleanProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$BooleanProperty"
import {$VoxelShape, $VoxelShape$Type} from "packages/net/minecraft/world/phys/shapes/$VoxelShape"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
import {$BlockBehaviour$Properties, $BlockBehaviour$Properties$Type} from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties"
...
import {$FeatureFlagSet, $FeatureFlagSet$Type} from "packages/net/minecraft/world/flag/$FeatureFlagSet"
import {$ResourceLocation, $ResourceLocation$Type} from "packages/net/minecraft/resources/$ResourceLocation"
import {$TerraformSign, $TerraformSign$Type} from "packages/de/cristelknight/doapi/forge/terraform/sign/$TerraformSign"
import {$Block, $Block$Type} from "packages/net/minecraft/world/level/block/$Block"
import {$StateDefinition, $StateDefinition$Type} from "packages/net/minecraft/world/level/block/state/$StateDefinition"
import {$SoundType, $SoundType$Type} from "packages/net/minecraft/world/level/block/$SoundType"
...
export class $TerraformWallSignBlock extends $WallSignBlock implements $TerraformSign {
static readonly "FACING": $DirectionProperty
...
constructor(texture: $ResourceLocation$Type, settings: $BlockBehaviour$Properties$Type)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TerraformWallSignBlock$Type = ($TerraformWallSignBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $TerraformWallSignBlock_ = $TerraformWallSignBlock$Type;
}}
...
declare module "packages/de/cristelknight/doapi/common/block/$SinkBlock" {
import {$LevelAccessor, $LevelAccessor$Type} from "packages/net/minecraft/world/level/$LevelAccessor"
import {$BooleanProperty, $BooleanProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$BooleanProperty"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
import {$BlockBehaviour$Properties, $BlockBehaviour$Properties$Type} from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties"
...
export class $SinkBlock extends $Block {
...
public static "spawnDripParticle"(level: $Level$Type, blockPos: $BlockPos$Type, blockState: $BlockState$Type): void
...
public "use"(state: $BlockState$Type, world: $Level$Type, pos: $BlockPos$Type, player: $Player$Type, hand: $InteractionHand$Type, hit: $BlockHitResult$Type): $InteractionResult
public "getSeed"(blockState: $BlockState$Type, blockPos: $BlockPos$Type): long
public "getShape"(state: $BlockState$Type, world: $BlockGetter$Type, pos: $BlockPos$Type, context: $CollisionContext$Type): $VoxelShape
public "animateTick"(state: $BlockState$Type, world: $Level$Type, pos: $BlockPos$Type, randomSource: $RandomSource$Type): void
public static "placeAt"(levelAccessor: $LevelAccessor$Type, blockState: $BlockState$Type, blockPos: $BlockPos$Type, i: integer): void
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
declare module "packages/de/cristelknight/doapi/forge/terraform/sign/$TerraformSign" {
import {$ResourceLocation, $ResourceLocation$Type} from "packages/net/minecraft/resources/$ResourceLocation"

export interface $TerraformSign {
...
export namespace $TerraformSign {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TerraformSign$Type = ($TerraformSign);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $TerraformSign_ = $TerraformSign$Type;
}}
declare module "packages/de/cristelknight/doapi/forge/terraform/sign/block/$TerraformSignBlock" {
import {$IntegerProperty, $IntegerProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$IntegerProperty"
import {$BooleanProperty, $BooleanProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$BooleanProperty"
import {$VoxelShape, $VoxelShape$Type} from "packages/net/minecraft/world/phys/shapes/$VoxelShape"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
...
export class $TerraformSignBlock extends $StandingSignBlock implements $TerraformSign {
static readonly "ROTATION": $IntegerProperty
static readonly "WATERLOGGED": $BooleanProperty
static readonly "AABB_OFFSET": float
static readonly "SHAPE": $VoxelShape
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TerraformSignBlock$Type = ($TerraformSignBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $TerraformSignBlock_ = $TerraformSignBlock$Type;
}}
...
declare module "packages/de/cristelknight/doapi/forge/terraform/sign/block/$TerraformHangingSignBlock" {
import {$IntegerProperty, $IntegerProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$IntegerProperty"
import {$BooleanProperty, $BooleanProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$BooleanProperty"
import {$VoxelShape, $VoxelShape$Type} from "packages/net/minecraft/world/phys/shapes/$VoxelShape"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
...
import {$ResourceLocation, $ResourceLocation$Type} from "packages/net/minecraft/resources/$ResourceLocation"
import {$Block, $Block$Type} from "packages/net/minecraft/world/level/block/$Block"
import {$TerraformHangingSign, $TerraformHangingSign$Type} from "packages/de/cristelknight/doapi/forge/terraform/sign/$TerraformHangingSign"
import {$StateDefinition, $StateDefinition$Type} from "packages/net/minecraft/world/level/block/state/$StateDefinition"
import {$SoundType, $SoundType$Type} from "packages/net/minecraft/world/level/block/$SoundType"

export class $TerraformHangingSignBlock extends $CeilingHangingSignBlock implements $TerraformHangingSign {
static readonly "ROTATION": $IntegerProperty
...
constructor(texture: $ResourceLocation$Type, guiTexture: $ResourceLocation$Type, settings: $BlockBehaviour$Properties$Type)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TerraformHangingSignBlock$Type = ($TerraformHangingSignBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $TerraformHangingSignBlock_ = $TerraformHangingSignBlock$Type;
}}
...
declare module "packages/de/cristelknight/doapi/forge/terraform/sign/$TerraformHangingSign" {
import {$ResourceLocation, $ResourceLocation$Type} from "packages/net/minecraft/resources/$ResourceLocation"
import {$TerraformSign, $TerraformSign$Type} from "packages/de/cristelknight/doapi/forge/terraform/sign/$TerraformSign"

export interface $TerraformHangingSign extends $TerraformSign {

 "getGuiTexture"(): $ResourceLocation
 "getTexture"(): $ResourceLocation
}

export namespace $TerraformHangingSign {
const probejs$$marker: never
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $TerraformHangingSign$Type = ($TerraformHangingSign);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $TerraformHangingSign_ = $TerraformHangingSign$Type;
}}
declare module "packages/de/cristelknight/doapi/common/block/$StackableEatableBlock" {
import {$VoxelShape, $VoxelShape$Type} from "packages/net/minecraft/world/phys/shapes/$VoxelShape"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
import {$BlockBehaviour$Properties, $BlockBehaviour$Properties$Type} from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties"
import {$CollisionContext, $CollisionContext$Type} from "packages/net/minecraft/world/phys/shapes/$CollisionContext"
...
export class $StackableEatableBlock extends $Block {
/**
 * 
 * @deprecated
 */
...
constructor(settings: $BlockBehaviour$Properties$Type, maxStack: integer)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $StackableEatableBlock$Type = ($StackableEatableBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $StackableEatableBlock_ = $StackableEatableBlock$Type;
}}
declare module "packages/de/cristelknight/doapi/terraform/boat/item/$TerraformBoatItem" {
import {$UUID, $UUID$Type} from "packages/java/util/$UUID"
import {$Item$Properties, $Item$Properties$Type} from "packages/net/minecraft/world/item/$Item$Properties"
import {$Level, $Level$Type} from "packages/net/minecraft/world/level/$Level"
import {$ItemStack, $ItemStack$Type} from "packages/net/minecraft/world/item/$ItemStack"
...
export class $TerraformBoatItem extends $Item {
static readonly "BY_BLOCK": $Map<($Block), ($Item)>
static readonly "BASE_ATTACK_DAMAGE_UUID": $UUID
static readonly "BASE_ATTACK_SPEED_UUID": $UUID
static readonly "MAX_STACK_SIZE": integer
...
constructor(boatTypeName: $ResourceLocation$Type, chest: boolean, settings: $Item$Properties$Type)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TerraformBoatItem$Type = ($TerraformBoatItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $TerraformBoatItem_ = $TerraformBoatItem$Type;
}}
declare module "packages/de/cristelknight/doapi/common/block/storage/$FlowerPotBigBlock" {
import {$SoundEvent, $SoundEvent$Type} from "packages/net/minecraft/sounds/$SoundEvent"
...
declare module "packages/de/cristelknight/doapi/common/block/$StackableBlock" {
import {$LevelAccessor, $LevelAccessor$Type} from "packages/net/minecraft/world/level/$LevelAccessor"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
import {$BlockBehaviour$Properties, $BlockBehaviour$Properties$Type} from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties"
import {$IdMapper, $IdMapper$Type} from "packages/net/minecraft/core/$IdMapper"
...
export class $StackableBlock extends $Block {
/**
 * 
 * @deprecated
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $StackableBlock$Type = ($StackableBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $StackableBlock_ = $StackableBlock$Type;
}}
...
declare module "packages/de/cristelknight/doapi/common/block/$FlowerBoxBlock" {
import {$SoundEvent, $SoundEvent$Type} from "packages/net/minecraft/sounds/$SoundEvent"
import {$StorageBlock, $StorageBlock$Type} from "packages/de/cristelknight/doapi/common/block/$StorageBlock"
import {$VoxelShape, $VoxelShape$Type} from "packages/net/minecraft/world/phys/shapes/$VoxelShape"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
...
declare module "packages/de/cristelknight/doapi/forge/terraform/sign/block/$TerraformWallHangingSignBlock" {
import {$BooleanProperty, $BooleanProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$BooleanProperty"
import {$VoxelShape, $VoxelShape$Type} from "packages/net/minecraft/world/phys/shapes/$VoxelShape"
import {$Direction, $Direction$Type} from "packages/net/minecraft/core/$Direction"
import {$BlockBehaviour$Properties, $BlockBehaviour$Properties$Type} from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties"
...
export class $TerraformWallHangingSignBlock extends $WallHangingSignBlock implements $TerraformHangingSign {
static readonly "FACING": $DirectionProperty
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $TerraformWallHangingSignBlock$Type = ($TerraformWallHangingSignBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $TerraformWallHangingSignBlock_ = $TerraformWallHangingSignBlock$Type;
}}
...
declare module "packages/de/cristelknight/doapi/common/block/$TableBlock" {
import {$LevelAccessor, $LevelAccessor$Type} from "packages/net/minecraft/world/level/$LevelAccessor"
import {$SoundEvent, $SoundEvent$Type} from "packages/net/minecraft/sounds/$SoundEvent"
import {$BooleanProperty, $BooleanProperty$Type} from "packages/net/minecraft/world/level/block/state/properties/$BooleanProperty"
