...
public "handler$cbb000$epicfight$setQuadSortOrigin"(arg0: $VertexSorting$Type, arg1: $CallbackInfo$Type): void
public "redirect$cbb000$epicfight$storeRenderedBuffer"(arg0: $BufferBuilder$Type, arg1: $VertexFormat$IndexType$Type): void
...
public "makeTrianglesSortingPoints"(): ($Vector3f)[]
...
export class $VertexFormat implements $VertexFormatAccessor, $VertexFormatAccessor$0, $ExtendedVertexFormat {
...
import {$Vector3f, $Vector3f$Type} from "packages/org/joml/$Vector3f"
import {$PoseStackExt, $PoseStackExt$Type} from "packages/io/github/flemmli97/tenshilib/mixinhelper/$PoseStackExt"
...
export class $PoseStack implements $IForgePoseStack, $CachingPoseStack, $PoseStackAccessor, $PoseStackExt, $TransformStack {
...
public "pushPose"(pose: $PoseStack$Pose$Type): void
...
public static "pushPose"(stack: $PoseStack$Type, pose: $PoseStack$Pose$Type): void
...
import {$Vector3f, $Vector3f$Type} from "packages/org/joml/$Vector3f"
import {$Vec3, $Vec3$Type} from "packages/net/minecraft/world/phys/$Vec3"
import {$HasOpenALVelocity, $HasOpenALVelocity$Type} from "packages/org/valkyrienskies/mod/mixinducks/com/mojang/blaze3d/audio/$HasOpenALVelocity"

export class $Listener implements $HasOpenALVelocity {

constructor()

public "setVelocity"(velocity: $Vector3dc$Type): void
...
set "velocity"(value: $Vector3dc$Type)
...
import {$Blaze3DAudioChannelAccessor, $Blaze3DAudioChannelAccessor$Type} from "packages/rbasamoyai/createbigcannons/mixin/client/$Blaze3DAudioChannelAccessor"
import {$Vec3, $Vec3$Type} from "packages/net/minecraft/world/phys/$Vec3"
import {$AudioStream, $AudioStream$Type} from "packages/net/minecraft/client/sounds/$AudioStream"
import {$HasOpenALVelocity, $HasOpenALVelocity$Type} from "packages/org/valkyrienskies/mod/mixinducks/com/mojang/blaze3d/audio/$HasOpenALVelocity"

export class $Channel implements $Blaze3DAudioChannelAccessor, $HasOpenALVelocity {
