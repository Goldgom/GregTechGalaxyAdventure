declare module "packages/maxhyper/dtneapolitan/blocks/$BananaFruitBlock" {
...
export class $BananaFruitBlock extends $FruitBlock {
/**
 * 
 * @deprecated
 */
 ...
 */
export type $BananaFruitBlock$Type = ($BananaFruitBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $BananaFruitBlock_ = $BananaFruitBlock$Type;
}}
